...
namespace Surging.Core.CPlatform.Serialization.Implementation
{
    ...
    public class StringByteArraySerializer : ISerializer<byte[]>
    {
        ...
        public byte[] Serialize(object instance, bool camelCase = false, bool indented = false)
        {
        ...
        public object Deserialize(byte[] content, Type type, bool camelCase = false, bool indented = false)
        {
